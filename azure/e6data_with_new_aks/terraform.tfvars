...
workspace_name                  = "jultuesday"                  # Name of the e6data workspace to be created
...
key_vault_name = "uzumaki"                                    # Key vault in which the ssl certificate is present for the endpoints,A new key vault will be created if this is empty
