...
region         = "germanywestcentral"    # Azure region
workspace_name = "aioneers" # Name of the e6data workspace to be created

# Details of existing resources
aks_resource_group_name = "customer-Aioneers" # Resource group to be use to deploy the AKS cluster in

# AKS cluster details
subscription_id        = "244ad77a-91e4-4a8e-9193-835d79ac55e2"  # Subscription ID of Azure subscription
aks_cluster_name       = "aioneers"                           # AKS cluster name
kube_version           = "1.32"                                  # Kubernetes version
kubernetes_namespace   = "aioneers"                                # Namespace to deploy e6data workspace
...
# Networking
cidr_block = ["10.225.0.0/16"] # CIDR block for the VNet
...
identity_pool_id = "us-east-1:1e767d84-6d13-49ed-8f95-2b89b9b87722" # The identity pool ID available in the e6data console after clicking on the "Create Workspace" button and selecting AZURE
identity_id      = "us-east-1:390f46a3-59d0-c8c0-3c04-5af1c4330dcc"      # The identity ID available in the e6data console, used for authentication and authorization in the workspace
...
karpenter_release_version      = "1.6.8"       # Karpenter release version
