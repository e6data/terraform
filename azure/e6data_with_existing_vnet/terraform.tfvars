...
prefix                          = "vnet"                       # Prefix for resources
region                          = "eastus"                       # Azure region
workspace_name                  = "vnet"                  # Name of the e6data workspace to be created
...
aks_cluster_name                = "vnet"                         # AKS cluster name
kube_version                    = "1.28"                        # Kubernetes version
kubernetes_namespace            = "vnet"                      # Namespace to deploy e6data workspace
private_cluster_enabled         = false                       # Private cluster enabled (true/false)

# Networking
vnet_name                      = "e6data-network"             # CIDR block for the VNet
aks_subnet_cidr                = ["10.210.128.0/24"]
aci_subnet_cidr                = ["10.210.129.0/24"]
