...
data "azurerm_resource_group" "aks_node_rg" {
  count = var.agfc_enabled ? 1 : 0
  name  = data.azurerm_kubernetes_cluster.aks_e6data.node_resource_group
}
...
resource "azurerm_federated_identity_credential" "alb_identity" {
  ...
  issuer  = data.azurerm_kubernetes_cluster.aks_e6data.oidc_issuer_url
...
resource "azurerm_role_assignment" "alb_identity_network_contributor" {
  count = var.agfc_enabled && var.vnet_id != "" ? 1 : 0
