...
#     labels = {
#       e6data-workspace-name = var.workspaces.0.name
#       app                   = "e6data"
#     }
...
#   title       = "e6data ${var.workspaces.0.name} Workspace Write Access ${var.random_string}"
...
#   title       = "e6data ${var.workspaces.0.name} Workspace Read Access ${var.random_string}"
...
#   title       = "e6data ${var.workspaces.0.name} clusterViewer ${var.random_string}"
...
#   title       = "e6data ${var.workspaces.0.name} GlobalAddress ${var.random_string}"
...
#   title       = "e6data ${var.workspaces.0.name} security policy ${var.random_string}"
...
#   title       = "e6data ${var.workspaces.0.name} workloadIdentityUser Access ${var.random_string}"
...
#   member  = "serviceAccount:${var.gcp_project_id}.svc.id.goog[${var.kubernetes_namespace}/${var.workspaces.0.name}]"
# }

# resource "google_project_iam_custom_role" "targetpoolAccess" {
#   role_id     = "${var.target_pool_role_name}_${var.random_string}"
#   title       = "e6data ${var.workspaces.0.name} targetpoolAccess ${var.random_string}"
