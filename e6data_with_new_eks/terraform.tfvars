...
workspace_name                  = "conn-har" ### Name of the e6data workspace to be created.
...
cluster_name                    = "conn-har"            ### The name of the Kubernetes cluster to be created for the e6data workspace.
...
kubernetes_namespace            = "conn-har" ### Value of the Kubernetes namespace to deploy the e6data workspace.
