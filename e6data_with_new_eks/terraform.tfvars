...
workspace_name                  = "fresh-vpc" ### Name of the e6data workspace to be created.
...
cluster_name                    = "fresh-vpc"            ### The name of the Kubernetes cluster to be created for the e6data workspace.
...
kubernetes_namespace            = "fresh-vpc" ### Value of the Kubernetes namespace to deploy the e6data workspace.
